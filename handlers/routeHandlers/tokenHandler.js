/*
 * Title: _token Handler
 * Description: Handling _token routing
...
handler._token.put = (requestProperties, callback) => {
    ...
    if (id && extend) {
        data.read('tokens', id, (ere1, tokenData) => {
...
handler._token.verify = (id, phone, callback) => {
    data.read('tokens', id, (err, tokenData) => {
        //console.log(Date.now(), parseJSON(tokenData).expires)
        if (!err && tokenData) {
